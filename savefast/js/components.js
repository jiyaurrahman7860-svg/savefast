/**
 * SaveFast.in - Reusable Web Components (Vanilla Web Components)
 * Includes: <site-header>, <site-footer>, <ad-slot>, and <related-tools>
 */
...
class SiteHeader extends HTMLElement {
  connectedCallback() {
    ...
    // Listen to theme change events to sync icons
...
class AdSlot extends HTMLElement {
  connectedCallback() {
    ...
    // Register to refresh/initialize whenever Firebase config details are updated
    window.addEventListener('firebase-initialized', () => this.fetchAdData());
    
    // If Firebase is already initialized, execute immediately
